...
CREATE TABLE IF NOT EXISTS `favorite` (
  ...
  KEY `fk_favorite_product1_idx` (`old_product_id`),
  KEY `fk_favorite_product2_idx` (`substitute_product_id`),
  CONSTRAINT `fk_favorite_product1` FOREIGN KEY (`old_product_id`) REFERENCES `product` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
